...
import moneycalculator.Comand.ActionListenerFactory;
import moneycalculator.UI.PanelCurrency;
import moneycalculator.UI.CurrencyViewer;
import moneycalculator.UI.MoneyViewer;
import moneycalculator.UI.MoneyViewerPanel;
import moneycalculator.UI.PanelMoney;
...
public class ApplicationFrame extends JFrame{
    ...
    public CurrencyViewer getCurrencyDialog() {
    ...
    private JPanel createMoneyDialogPanel() {
        PanelMoney panel = new PanelMoney();
        this.moneyDialog = panel;
        return panel;
    }

    private JPanel createCurrencyDialogPanel() {
        PanelCurrency panel = new PanelCurrency("USD");
